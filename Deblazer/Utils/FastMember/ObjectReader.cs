...
//        internal static ObjectReader Create<T>(IEnumerable<T> source, params string[] members)
//        {
...
//        /// <param name="source">The sequence of objects to represent</param>
//        /// <param name="members">The members that should be exposed to the reader</param>
//        internal ObjectReader(Type type, IEnumerable source, params string[] members)
//        {
