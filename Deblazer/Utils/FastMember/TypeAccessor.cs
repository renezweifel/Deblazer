...
//        private static readonly MethodInfo convertToInt32 = typeof(IConvertibleToInt32).GetMethod(nameof(IConvertibleToInt32.ConvertToInt32));
//        private static readonly MethodInfo convertNullableToInt32 = typeof(TypeAccessor).GetMethod(nameof(ConvertNullableToInt32), BindingFlags.Public | BindingFlags.Static);
//
//        /// <summary>
//        /// Must be public otherwise we get a MethodAccessException.
//        /// </summary>
//        [CanBeNull]
//        public static int? ConvertNullableToInt32(object id)
//        {
//            if (id == null)
//            {
//                return null;
//            }
//
//            return ((IConvertibleToInt32)id).ConvertToInt32();
//        }
//
...
//                                }
//
//                                var isNullableIdType = prop.PropertyType.IsGenericType
//                                    && prop.PropertyType.GetGenericTypeDefinition() == typeof(Nullable<>)
//                                    && typeof(IConvertibleToInt32).IsAssignableFrom(prop.PropertyType.GenericTypeArguments[0]);
//
//                                if (isNullableIdType)
//                                {
//                                    il.EmitCall(OpCodes.Call, convertNullableToInt32, null);
//                                    il.Emit(OpCodes.Box, typeof(int?));
//                                }
//                                else if (typeof(IConvertibleToInt32).IsAssignableFrom(prop.PropertyType))
//                                {
//                                    il.EmitCall(OpCodes.Callvirt, convertToInt32, null);
//                                    il.Emit(OpCodes.Box, typeof(int));
//                                }
//                            }
//                            else
...
//                    throw new InvalidOperationException("This should be unreachable since nested types always have a declaring type");
//                }
//            }
//            if (!type.IsPublic)
//            {
